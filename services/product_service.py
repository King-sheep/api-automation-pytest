...
class ProductService:
    ...
    def create_product(self, product_payload: dict):
        ...
        """
        return self.client.request("POST", "/api/v1/products", json=product_payload)
    ...
    def update_product(self, product_payload: dict):
        ...
        """
        return self.client.request("PUT", "/api/v1/products", json=product_payload)
    ...
    def delete_products(self, product_ids: list[int]):
        ...
        """
        return self.client.request("DELETE", "/api/v1/products", json=product_ids)